...
func FetchGeminiModels(tenantCtx context.Context, baseURL, apiKey, proxyURL string) ([]string, error) {
	client, err := service.GetHttpClientWithProxy(tenantCtx, proxyURL)
	if err != nil {
